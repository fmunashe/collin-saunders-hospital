...
class Staff extends Resource
{
    ...
    public function fields(NovaRequest $request): array
    {
        return [
            ...
            Select::make('Designation')->options(collect(StaffDesignation::cases())->mapWithKeys(fn ($d) => [$d->value => $d->label()]))->rules('required')->searchable()->displayUsingLabels()->filterable(),
            ...
            Select::make('Gender')->options(collect(Gender::cases())->mapWithKeys(fn ($g) => [$g->value => ucfirst($g->value)]))->nullable()->searchable()->displayUsingLabels()->hideFromIndex(),
